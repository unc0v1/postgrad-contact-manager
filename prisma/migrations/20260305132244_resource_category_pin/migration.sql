...
INSERT INTO "new_ResourceLink" ("createdAt", "description", "id", "title", "updatedAt", "url", "userId") SELECT "createdAt", "description", "id", "title", "updatedAt", "url", "userId" FROM "ResourceLink";
