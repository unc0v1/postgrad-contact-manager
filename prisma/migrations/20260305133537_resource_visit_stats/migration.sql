...
INSERT INTO "new_ResourceLink" ("category", "createdAt", "description", "id", "isPinned", "title", "updatedAt", "url", "userId") SELECT "category", "createdAt", "description", "id", "isPinned", "title", "updatedAt", "url", "userId" FROM "ResourceLink";
